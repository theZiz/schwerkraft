...
schwerkraft: schwerkraft.c planet.o level.o ship.o font.o
	$(CPP) $(CFLAGS) schwerkraft.c planet.o level.o ship.o font.o $(SDL) $(INCLUDE) -L. $(LIB) $(STATIC) $(DYNAMIC) -lsparrow3d -o schwerkraft
